...
--
-- This program uses the simulated noisy channel to investigate various techniques for computing
-- checksums. It passes blocks of data over the channel and checks the result to see if the
-- checksum detects any errors that occurred.
--
