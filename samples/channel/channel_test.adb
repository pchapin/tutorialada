...
--
-- This program could be better. It should collect statistical data to
...
procedure Channel_Test is
  ...
  procedure Get_Float_Value is new Read_Value(
    Data_Type => Float,
    Get       => Flt_IO.Get
    );

  procedure Get_Integer_Value is new Read_Value(
    Data_Type => Integer,
    Get       => Int_IO.Get
    );
