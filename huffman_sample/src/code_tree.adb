...
package body Code_Tree is
   ...
   procedure Build_Tree is
      ...
      procedure Purge_Nodes (A, B : Index_Type) is
         High_Index : Index_Type := A;  -- This will be the highest of the two indices.
         Low_Index  : Index_Type := B;  -- This will be the lowest of the two indices.
         Temp_Index : Index_Type;

         --  This procedure purges one node only.
         procedure Compress_List (Index_To_Remove : Index_Type) is
         begin
      ...
      begin -- Purge_Nodes
         --  Exchange the indices if necessary.
