...
\newterm{title case}.} The Ada language does not enforce this convention, but it is a well
...
installed Alire, you will need to create a \newterm{crate} for your program. Every program
...
the procedure stored in that file. The \filename{adb} extension stands for ``Ada body.'' This is
in contrast with Ada specification files that are given an extension of \filename{ads}. You will
